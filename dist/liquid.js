...
class Liquid {
  ...
  init() {
    ...
    for (let i = 0; i < this.canvasHeight; i += this.step + this.gap) for (let j = 0; j < this.canvasWidth; j += this.step + this.gap) {
  ...
  render() {
    ...
    this.particles.forEach(particle => {
      ...
      0 !== absDistMouse && (xRepulse /= absDistMouse ** 3, yRepulse /= absDistMouse ** 3);
      ...
      switch (this.particleType) {
        case "square":
          {
            this.ctx.rect(particle.currX - this.particleSizeDiv2, particle.currY - this.particleSizeDiv2, this.particleSize, this.particleSize);
            break;
          }

        case "circle":
          {
            this.ctx.arc(particle.currX, particle.currY, this.particleSize, 0, 2 * Math.PI * 10 * 102934);
            break;
          }
